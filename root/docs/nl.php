...
?>
        ...
        <p>
        Voor hulp bij de verschillende thema's en de manier waarop WebsiteBaker werkt staan
         <a href="http://help.websitebaker.org/" target="_blank">de officiële WebsiteBaker hulppagina's</a> ter beschikking. Voor specifieke vragen of problemen kunt u ook
         <a href="http://forum.websitebaker.org/" target="_blank">het WebsiteBaker Forum</a> doorzoeken.
        </p>
        <br />
        <hr />
        <br />
        ...
        <p>
        There exists numerous WebsiteBaker templates, designs, modules and add-ons. Check out the
         <a href="http://addons.websitebaker.org/" target="_blank">official WebsiteBaker Add-ons Repository</a> to find what you need.
        </p>
        <br />
        <hr />
        <br />
        ...
        <ul>
        <li><a target="_blank" href="http://localhost:4001/wbdemo/"><strong>Directe toegang tot de frontend </strong></a>(voor bezoekers)</li>
        <li><a target="_blank" href="http://localhost:4001/wbdemo/admin/"><strong>Directe toegang tot de backend</strong></a>(administratie)<br /><br />
