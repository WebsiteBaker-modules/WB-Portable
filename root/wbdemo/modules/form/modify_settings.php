...
if(function_exists('edit_module_css')) { edit_module_css('form'); }
...
<table>
    <tr>
        ...
        <td align="right">
            <input type="button" value="<?php echo $TEXT['CANCEL']; ?>" onclick="window.location = '<?php echo ADMIN_URL; ?>/pages/modify.php?page_id=<?php echo $page_id.$sec_anchor; ?>';" style="width: 100px; margin-top: 5px;" />
        </td>
    </tr>
</table>
</form>
