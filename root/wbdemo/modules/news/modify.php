...
?><div class="jsadmin hide"></div>
    <table class="news-post" id="tableData">
        <thead>
            <tr >
                <th style=" width: 3%;">&nbsp;</th>
    ...
    while($post = $query_posts->fetchRow( MYSQLI_ASSOC )) {
        ...
        <tr class=" sectionrow">
            ...
            <?php if($post['position'] != 1 ) { ?>
                <a href="<?php echo WB_URL; ?>/modules/news/move_up.php?page_id=<?php echo $page_id; ?>&amp;section_id=<?php echo $section_id; ?>&amp;post_id=<?php echo $pid; ?>&amp;move_id=<?php echo $post['post_id']; ?>&amp;position=<?php echo $post['position']; ?>&amp;module=<?php echo $sModulName; ?>" title="<?php echo $TEXT['MOVE_DOWN']; ?>">
            ...
            <?php if($post['position'] != $num_posts ) { ?>
                <a href="<?php echo WB_URL; ?>/modules/news/move_down.php?page_id=<?php echo $page_id; ?>&amp;section_id=<?php echo $section_id; ?>&amp;post_id=<?php echo $pid; ?>&amp;move_id=<?php echo $post['post_id']; ?>&amp;position=<?php echo $post['position']; ?>&amp;module=<?php echo $sModulName; ?>" title="<?php echo $TEXT['MOVE_UP']; ?>">
...
if($query_groups->numRows() > 0) {
    ...
    ?>
    <table class="news-group" id="NewsGroupDataTable">
        <thead>
            <tr >
