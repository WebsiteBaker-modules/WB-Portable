...
?>
	...
	<div class="togglebox-content">
		...
		<div class="dynamicGrid-outer">
			<a id="linkbox_manuals" class="linkbox dynamicGrid_3" href="http://help.websitebaker.org/en/help/helpproject.php" title="Manuals" target="_blank"><?php echo $TEXT['MANUALS']; ?></a>
			...
			<a id="linkbox_addons" class="linkbox dynamicGrid_3" href="http://addon.websitebaker-next.de/pages/en/browse-add-ons.php?id=04CEF0E1/" title="AddOns" target="_blank"><?php echo $TEXT['ADDONS']; ?></a>
		</div>
		...
		<div id="togglebox_scrollbox">
			...
			<?php
				...
				$url = "http://websitebaker.org/pages/en/news.php";
